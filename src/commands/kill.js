...
class HackCommand extends Command {
	constructor(context, options) {
		super(context, {
			...options,
			name: 'kill',
			description: 'kill someone who deserved',
		});
	}
	...
	registerApplicationCommands(registry) {
		registry.registerChatInputCommand((builder) =>
			builder
				.setName('kill')
				.setDescription('kill someone who deserved')
				.addUserOption((option) =>
					option
						.setName('target')
						.setDescription('who deserves to be killed')
						.setRequired(true),
				),
		);
	}
	...
	async chatInputRun(interaction) {
		const t = interaction.options.getMember('target');
		const target = t.user.username;

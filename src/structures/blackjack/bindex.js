...
module.exports = async (message, options) => {
	...
	const doubledown = options.doubledown;
	const insurance = options.insurance;
	const split = options.split;
	const resultEmbed = options.resultEmbed;
	const normalEmbed = options.normalEmbed;
	...
	// set the embeds
	const winEmbed = { title: 'You won!', color: 0x008800, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const loseEmbed = { title: 'You lost!', color: 0xFF0000, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const tieEmbed = { title: 'It\'s a tie.', color: 0xFFFF00, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitWinEmbed = { title: 'You split and won both hands!', color: 0x008800, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitLoseEmbed = { title: 'You split and lost both hands!', color: 0xFF0000, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitTieEmbed = { title: 'You split and tied both hands!', color: 0xFFFF00, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitTieWinEmbed = { title: 'You split: First hand ties and second hand wins.', color: 0x008800, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitWinTieEmbed = { title: 'You split: First hand wins and second hand ties.', color: 0x008800, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitTieLoseEmbed = { title: 'You split: First hand ties and second hand loses.', color: 0xFF0000, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitLoseTieEmbed = { title: 'You split: First hand loses and second hand ties.', color: 0xFF0000, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitWinLoseEmbed = { title: 'You split: First hand wins and second hand loses.', color: 0xFFFF00, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const splitLoseWinEmbed = { title: 'You split: First hand loses and second hand wins.', color: 0xFFFF00, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const insWinEmbed = { title: 'You won (paid insurance)!', color: 0x008800, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const insLoseEmbed = { title: 'You lost (paid insurance)!', color: 0xFF0000, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const insTieEmbed = { title: 'It\'s a tie (paid insurance).', color: 0xFF0000, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const insPayEmbed = { title: 'Insurance Payout!', color: 0x008800, description: '', fields: [], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	const timeoutEmbed = { title: 'Time\'s up!', color: 0xFF0000, description: 'You took more than 30 seconds to respond. The time is up and the game has canceled.', fields: [], author: { name: message.member.user.tag, icon_url: message.member.displayAvatarURL() } };
	const cancelEmbed = { title: 'Game canceled.', color: 0xFF0000, description: 'You decided to cancel your ongoing blackjack game.', fields: [], author: { name: message.member.displayName, icon_url: message.member.displayAvatarURL() } };
	const generalEmbed = normalEmbed === false ? options.normalEmbedContent : { title: 'Blackjack', color: Math.floor(Math.random() * (0xffffff + 1)), fields: [{ name: 'Your hand', value: '', inline: true }, { name: 'Dealer\'s hand', value: '', inline: true }], author: { name: message.member.displayName, icon_url: message.member.user.displayAvatarURL() } };
	...
	if (yourvalue === 21 && dealervalue != 21) {
		...
		if (options.resultEmbed === true) {
			...
			loseEmbed.fields.push({ name: 'Your hand', value: `Cards: [\`${yourcards[0].emoji} ${yourcards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) [\`${yourcards[1].emoji} ${yourcards[1].rank}\`](https://i.imgur.com/1Ob4BIs.png)\nTotal: ${yourvalue}` });
			loseEmbed.fields.push({ name: 'Dealer\'s hand', value: `Cards: [\`${dealercards[0].emoji} ${dealercards[0].rank}\`](https://i.imgur.com/1Ob4BIs.png) [\`${dealercards[1].emoji} ${dealercards[1].rank}\`](https://i.imgur.com/1Ob4BIs.png)\nTotal: ${dealervalue}` });
	...
	const finalResult = await (options.buttons ? new Collect().buttonCollect(currentMessage, userId, yourcards, dealercards, currentDeck, options) : new Collect().messageCollect(currentMessage, userId, yourcards, dealercards, currentDeck, options, allFilter));
